 ...
 * [**xt_geoip-block_countries**](lib/xt_geoip-block_countries) : applies iptables rules to DROP all IP traffic from each country in the block countries [block list (/etc/xt_geoip-block_countries)](#Configuration)
